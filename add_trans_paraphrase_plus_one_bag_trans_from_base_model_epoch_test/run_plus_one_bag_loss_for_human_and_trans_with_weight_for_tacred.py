...
def run():
    ...
    seed_list = [0, 1, 2]   
    output_dir=f"/data1/jjyu/rc_one_bag_exps/add_trans_plus_loss_with_weight_from_base_bert"
    mt_system_list = ["all"]    # "google", "baidu", "xiaoniu",             
    num_train_epochs_list = [2, 3, 4]
                ...
                for per_gpu_batch_size in per_gpu_batch_size_list:
                    ...
                    for learning_rate in learning_rate_list:
                        for num_train_epochs in num_train_epochs_list:
                            run_cmd = f"CUDA_VISIBLE_DEVICES={cuda_num} python -u plus_one_bag_loss_for_human_and_trans_with_weight.py " \
