...
def run():
    ...
    # bert_model = "/data3/jjyu/work/RelationClassification/BERT_BASE_DIR/bert-large-uncased"
                ...
                for per_gpu_batch_size in per_gpu_batch_size_list:
                    ...
                    for learning_rate in learning_rate_list:
                        for num_train_epochs in num_train_epochs_list:
                            run_cmd = f"CUDA_VISIBLE_DEVICES={cuda_num} python -u plus_ave_bag_loss_for_human_and_trans_with_weight.py " \
